...
def upgrade() -> None:
    ...
    sa.Column('priority', sa.Enum('low', 'medium', 'high', 'critical', name='ticket_priority'), server_default='medium', nullable=False),
    ...
    sa.CheckConstraint('(assigned_to IS NULL) = (assigned_at IS NULL)', name=op.f('ck_tickets_assignment_consistent')),
